...
function Koreacompo() {
  ...
  useEffect(() => {
    ...
    axios
      .get(url)
      .then((response) => {
        setDate(response.data.response.header);
        setLoading(true);
    ...
    <div class="flex justify-center items-center">
      <div class="w-4/5 mb-10 justify-center items-center text-1xl flex-wrap flex flex-row rounded-md shadow-2xl pb-4 pt-4">
        <div class="basis-1/5 flex flex-col justify-center items-center">
          ...
          <div className="shadow-md font-semibold border-2 rounded-2xl pl-2 pr-2 bg-slate-300 text-red-600">
            11568
          </div>
        </div>
        <div className="basis-1/5 flex flex-col justify-center items-center">
          ...
          <div className="shadow-md border-2 rounded-2xl pl-2 pr-2 bg-slate-300">
            11568
          </div>
        </div>
        <div className="basis-1/5 flex flex-col justify-center items-center">
          <div>입원환자</div>
          <div className="font-semibold pt-1 pb-1 text-indigo-500">
            16833838
          </div>
          <div className="shadow-md font-semibold border-2 rounded-2xl pl-2 pr-2 bg-slate-300 text-indigo-500">
            11568
          </div>
        </div>
        <div className="basis-1/5 flex flex-col justify-center items-center">
